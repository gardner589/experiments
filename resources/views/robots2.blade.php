  ...
  <body>
        ...
        class Robot {
          	...
          	update () {
          		...
          		// ---- beat ----
          		if (++this.frame % 8 === 0) this.dir = -this.dir/2;

          		// ---- create giants ----
          		if (dancerDrag && this === dancerDrag && this.size < 16 && this.frame > 750) {
          			dancerDrag = null;
          			dancers.push(
          				new Robot(
          					this.color,
          		...
          		for ( let point of this.points ) {
          			...
          			if (this === dancerDrag && point === pointDrag) {
          				...
          				point.x += (pointer.x - point.x) * 1;
          				point.y += (pointer.y - point.y) * 1;
          			...
          			if (this !== dancerDrag) {
          				...
          				point.fn && point.fn(5 * Math.sqrt(this.size), this.dir/2);
          	...
          	draw () {
          		...
          		for ( let link of this.links ) {
          			if (link.size) {
          				...
          				// ---- shadow ----
          				ctx.save();
          				ctx.translate(link.p0.x + link.size * 0.05, link.p0.y + link.size * 0.05);
          				ctx.rotate(a);
          				ctx.drawImage(link.shadow, -link.size * 0.05, -link.size * 0.05, d + link.size, link.size);
          				ctx.restore();
          ...
          class Link {
          	...
          	constructor ( parent, p0, p1, dist, size, light, force ) {
          		...
          		this.force    = force || .55;
          		this.image    = stroke("hsl(" + parent.color + " ,45%, " + (parent.light * this.light) + "%)", true);
          		this.shadow   = stroke("rgba(0,0,0,.75)");
        ...
        <script src="https://w.soundcloud.com/player/api.js" charset="utf-8"></script>
          ...
          <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/302539535&amp;color=666666&amp;auto_play=true&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
